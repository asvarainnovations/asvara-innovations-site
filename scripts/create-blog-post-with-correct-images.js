...
async function createBlogPost() {
  try {
    ...
    // Create the blog post with correct images
    const blogPost = await prisma.blogPost.create({
      data: {
        title: "Women & Political Backwardness: A Comprehensive Analysis of Uttarakhand and Himachal Pradesh (Correct Images)",
...
![Female Candidates in Uttarakhand](/blog-images/fig1-female-candidates-uttarakhand.png)

![Female Candidates in Himachal Pradesh](/blog-images/fig2-female-candidates-himachal.png)
...
![Female Population and Female Candidates - Uttarakhand](/blog-images/fig3-uttarakhand-district-data.png)
...
![Female Population and Female Candidates - Himachal Pradesh](/blog-images/fig4-himachal-district-data.png)
...
**LinkedIn:** [Sajal Anand](https://www.linkedin.com/in/sajal-anand-508993215)`,
        ...
        coverImage: "/blog-images/sajal-blog-cover-image.png",
        tags: {
